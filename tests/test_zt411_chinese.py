...
def check_printer():
    ...
    try:
        ...
        # 查找ZT411
        zt411 = [p for p in printers if 'ZT411' in p or 'ZDesigner' in p]
        
        if zt411:
            print(f"[OK] 找到ZT411打印机: {zt411[0]}")
            
            # 检查状态
            try:
                handle = win32print.OpenPrinter(zt411[0])
            ...
            print("[WARNING] 未找到ZT411打印机")
            print("请确认打印机名称包含'ZT411'或'ZDesigner'")
...
def main():
    """主测试流程"""
    print("\n" + "="*70)
    print("ZT411 中文打印测试套件")
    print("="*70)
    print()
    print("打印机型号: ZDesigner ZT411-300dpi ZPL")
    print()
    print("测试计划:")
